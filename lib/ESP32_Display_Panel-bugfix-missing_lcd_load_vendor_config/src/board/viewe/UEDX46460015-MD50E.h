...
#ifdef ESP_PANEL_USE_CUSTOM_BOARD

#undef ESP_PANEL_USE_CUSTOM_BOARD
...
#define ESP_PANEL_LCD_WIDTH         (475)
...
/* Interrupt pin */
#define ESP_PANEL_TOUCH_IO_INT          (-1)       // Poll touch data to avoid repeated ISR timeout logs
